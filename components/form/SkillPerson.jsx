          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-800 rounded-lg p-6 border border-blue-600">
              ...
              <div className="space-y-2 text-sm">
                <p className="text-blue-200"><span className="text-white font-medium">Name:</span> {formData.fullName}</p>
                ...
                {formData.skills && <p className="text-blue-200"><span className="text-white font-medium">Skills:</span> {formData.skills.substring(0, 100)}...</p>}
                {formData.experience && <p className="text-blue-200"><span className="text-white font-medium">Experience:</span> {formData.experience.substring(0, 100)}...</p>}
              </div>
            </div>
          </div>
        );
       ...
       <div className="flex-1 flex flex-col gap-4 w-full max-w-2xl mx-auto">
        <div className="text-center flex flex-col gap-4 md:h-80">
          ...
          <motion.h2
                    ...
                    >Join Our Network of</motion.h2>
           <motion.h2
                      className="text-2xl md:text-4xl font-bold text-white"
                      initial={{ opacity: 0, y: -20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.6, ease: "easeOut", delay: 0.2 }}
                    >Skilled Professionals</motion.h2>
        </div>
        {/* Progress Bar */}
