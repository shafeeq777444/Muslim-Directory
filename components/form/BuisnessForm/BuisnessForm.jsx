  ...
  const defaultFormData={
    ...
    const validateStep1 = () => {
        ...
        if (!formData.businessName) {
            newErrors.fullName = "Business Name must be add";
        }

        // Email: required and must follow valid format
        if (!formData.businessCategory) {
            newErrors.businessCategory = "select atleast one category";
        }
    ...
    const validateStep2 = () => {
        ...
        if (!formData.position) {
            newErrors.position = "Business Position is required";
        }
    ...
    const validateStep3 = () => {
        ...
        if (!formData.state) {
            newErrors.state = "state/provison is required";
        }
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative">
                                ...
                                {errors?.businessCategory && (
                                    <p className="text-xs pl-1 pt-1 text-red-800">{errors.businessCategory}</p>
                                )}
                                ...
                                {showCategoryDropdown && (
                                    <div className="absolute z-10 w-full mt-1 bg-slate-700 border border-blue-600 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                                        {businessCategories
                                            .filter((x) => x.includes(formData.businessCategory.trim()))
                                            .map((category, index) => (
                                                <div
                                                    key={index}
                                                    onClick={() => {
                            ...
                            {errors?.businessDescription && (
                                <p className="text-xs pl-1 pt-1 text-red-800">{errors.businessDescription}</p>
                            )}
                        </div>
                    </div>
                );
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    />
                                    {errors?.firstName && (
                                        <p className="text-xs pl-1 pt-1 text-red-800">{errors.firstName}</p>
                                    )}
                                </div>
                                <div>
                                    <input
                                    ...
                                    />
                                    {errors?.lastName && (
                                        <p className="text-xs pl-1 pt-1 text-red-800">{errors.lastName}</p>
                                    )}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                {errors?.position && <p className="text-xs pl-1 pt-1 text-red-800">{errors.position}</p>}
                            </div>
                        </div>
                    </div>
                );
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                {errors?.streetAddress && (
                                    <p className="text-xs pl-1 pt-1 text-red-800">{errors.streetAddress}</p>
                                )}
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <input
                                        ...
                                        required
                                    />
                                    {errors?.city && <p className="text-xs pl-1 pt-1 text-red-800">{errors.city}</p>}
                                </div>
                                <div>
                                    <input
                                        type="text"
                                        ...
                                        required
                                    />
                                    {errors?.state && <p className="text-xs pl-1 pt-1 text-red-800">{errors.state}</p>}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                />
                                {errors?.postalCode && (
                                    <p className="text-xs pl-1 pt-1 text-red-800">{errors.postalCode}</p>
                                )}
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-blue-800 rounded-lg p-6 border border-blue-600">
                            ...
                            <div className="space-y-2 text-sm">
                                <p className="text-blue-200">
                                    <span className="text-white font-medium">Business:</span> {formData.businessName}
                                </p>
                                <p className="text-blue-200">
                                    <span className="text-white font-medium">Category:</span> {formData.businessCategory}
                                </p>
                                <p className="text-blue-200">
                                    <span className="text-white font-medium">Owner:</span> {formData.firstName}{" "}
                                    {formData.lastName}
                                </p>
                                <p className="text-blue-200">
                                    <span className="text-white font-medium">Position:</span> {formData.position}
                                </p>
                                <p className="text-blue-200">
                                    <span className="text-white font-medium">Location:</span> {formData.city},{" "}
                                    {formData.state}
                                </p>
                                <p className="text-blue-200">
                                ...
                                {formData.website && (
                                    <p className="text-blue-200">
                                        <span className="text-white font-medium">Website:</span> {formData.website}
                                    </p>
                                )}
                            </div>
                        </div>
                    ...
                    <div className="flex scale-75 md:flex-nowrap items-center justify-center md:scale-100 mb-8 gap-2">
                        {[1, 2, 3, 4].map((step) => (
                            <div key={step} className="flex items-center">
                                ...
                                {step < 4 && (
                                    <div
                                        className={`w-10 md:w-16 h-1 mx-2 ${
